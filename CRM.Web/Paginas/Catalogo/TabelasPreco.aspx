        ...
        <div class="crm-form-card">
            ...
            <div class="row g-2 align-items-end">
                <div class="col-md-4">
                    ...
                    <asp:TextBox ID="txtNome" runat="server" CssClass="form-control" MaxLength="100" placeholder="Nome da tabela de preços" />
                ...
                <div class="col-md-auto">
                    <div class="form-check mb-2">
                        ...
                        <label class="form-check-label">Predefinida</label>
                    </div>
                </div>
                <div class="col-md-auto">
            ...
            <ItemTemplate>
                <tr>
                    ...
                    <td class="text-end crm-row-actions">
                        <a href="TabelaPrecoDetalhe.aspx?id=<%# Eval("PriceTableId") %>" class="btn btn-sm btn-outline-secondary" title="Gerir Preços">
